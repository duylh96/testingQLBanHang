...
public class TestMatHangDAO {
	...
	// Không tiến hành kiểm tra tính hợp lệ của hàm xóa và sửa
	// tại vì hàm xóa, sẽ dựa vào vị trí con tro để xóa mặt hàng
	// nên không có vụ true/false được, sửa cũng dựa vào dữ liệu
	// ở các textview, nên ở đây ta cho dữ liệu ở textview, mà đã
	// có hàm kiểm
